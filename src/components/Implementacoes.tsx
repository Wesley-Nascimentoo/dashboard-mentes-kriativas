          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-slate-200">Implementadas</span>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-slate-200">Em Progresso</span>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-slate-200">Esta Semana</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
          <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 shadow-xl backdrop-blur-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-slate-700 dark:text-slate-300">Total de Ideias</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Em Avaliação</p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900 dark:to-emerald-900 shadow-xl backdrop-blur-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-green-700 dark:text-green-300">Implementadas</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-sm text-green-600 dark:text-green-400">
                {((implantadas / totalIdeias) * 100).toFixed(1)}% taxa de sucesso
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-900 dark:to-orange-900 shadow-xl backdrop-blur-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-amber-700 dark:text-amber-300">Em Progresso</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-sm text-amber-600 dark:text-amber-400">Desenvolvimento Ativo</p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 shadow-xl backdrop-blur-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-blue-700 dark:text-blue-300">Em Análise</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-sm text-blue-600 dark:text-blue-400">Avaliação Pendente</p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-red-50 to-rose-100 dark:from-red-900 dark:to-rose-900 shadow-xl backdrop-blur-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-red-700 dark:text-red-300">Reprovadas</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-sm text-red-600 dark:text-red-400">Não Viáveis</p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-purple-50 to-violet-100 dark:from-purple-900 dark:to-violet-900 shadow-xl backdrop-blur-md">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-purple-700 dark:text-purple-300">Esta Semana</CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-sm text-purple-600 dark:text-purple-400">Implementadas</p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="shadow-2xl hover:shadow-3xl transition-all duration-500 border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
            <CardHeader className="border-b bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 rounded-t-lg">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-200">Tendência de Implementação Semanal</CardTitle>
                  <CardDescription className="text-slate-600 dark:text-slate-400">
                    Performance de implementação ao longo do tempo
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
          ...
          <Card className="shadow-2xl hover:shadow-3xl transition-all duration-500 border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
            <CardHeader className="border-b bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900 dark:to-violet-900 rounded-t-lg">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-200">Análise de Distribuição por Status</CardTitle>
                  <CardDescription className="text-slate-600 dark:text-slate-400">
                    Distribuição atual de ideias por status
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
        ...
        <Card className="shadow-2xl hover:shadow-3xl transition-all duration-500 border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
          <CardHeader className="border-b bg-gradient-to-r from-slate-100 to-blue-50 dark:from-slate-800 dark:to-blue-900 rounded-t-lg">
            <div className="flex items-center gap-4">
              ...
              <div>
                <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-200">Atividade Recente de Implementações</CardTitle>
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  Últimas 10 ideias implementadas com sucesso
                </CardDescription>
              </div>
            </div>
          </CardHeader>
                  ...
                  <div key={index} className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-xl bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-800 dark:to-blue-900 hover:shadow-lg transition-all duration-300">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <p className="font-semibold text-slate-800 dark:text-slate-200">Ideia #{item['N° ID']}</p>
                      </div>
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <div>
                <CardTitle className="text-3xl font-bold bg-gradient-to-r from-purple-300 to-violet-300 bg-clip-text text-transparent">
                  Resumo de Inteligência de Implementações
                </CardTitle>
                <CardDescription className="text-slate-300 text-lg mt-2">
                  Relatório de Análise Avançada - Plataforma de Implementação de Inovações
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid gap-8 md:grid-cols-4">
              <div className="text-center p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-sm text-slate-300 font-medium">Implementadas com Sucesso</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-sm text-slate-300 font-medium">Desenvolvimento Ativo</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-sm text-slate-300 font-medium">Em Análise</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-sm text-slate-300 font-medium">Performance Semanal</p>
              </div>
            </div>
          </CardContent>
        </Card>
